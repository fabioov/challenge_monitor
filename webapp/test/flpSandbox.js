		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FBP Challenge Monitor",
									"targetURL": "#brcomchallengemonitorchallengemonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomchallengemonitorchallengemonitor-display": {
								"semanticObject": "brcomchallengemonitorchallengemonitor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.challenge.monitor.challengemonitor",
									"url": sap.ui.require.toUrl("br/com/challenge/monitor/challengemonitor")
								}
							}
						}
					}
